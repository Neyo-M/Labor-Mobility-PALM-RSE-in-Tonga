...
\keywords{Labor Mobility Sceheme, PALM, RSE, Remittances, Tonga}
...
\end{tauenv}
       ...
       \begin{figure*}[tp] % t for position at the top of the current page; b for position at the bottom; p for new page
		...
		\begin{subfigure}[b]{0.3\linewidth} % Fig (b)
			...
			\label{fig:figb}
		\end{subfigure}
		\caption{Summary infographic of RSE productivity and engagement insights \cite{PFGPlots}.}
		\label{fig:examplefloat}
	\end{figure*}
...
\begin{itemize}
    ...
    \item \textbf{Diminishing marginal return} - RSE workers’ earnings tend to plateau around the fourth season of work, suggesting that employers may not have additional productivity gains by bringing back the same workers in successive seasons beyond their fourth year.
